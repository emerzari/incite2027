...
\def\bff{{\bf f}}
\def\tp {{\tilde p}}
\def\utp {\underline {\tilde p}}
\def\upt {\underline {\tilde p}}
\def\btu{{\tilde {\bf u}}}
...
\def\utb{{\tilde {\underline b}}}
\def\utw{{\tilde {\underline w}}}
...
\def\ubu{{\underline {\bf u}}}
\def\uub{{\underline {\bf u}}}
\def\ubw{{\underline {\bf w}}}
...
\def\udp{{\delta{\underline p}}}
\def\upb{{\bar {\underline p}}}
